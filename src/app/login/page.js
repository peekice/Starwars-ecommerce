'use client'
import {loginFormControls, LoginFormControls, registrationFormControls} from "@/utils";
                    ...
                    <div className="w-full mt-10 mr-0 mb-0 ml-0 relative max-w-2xl lg:mt-0 lg:w-5/12">
                        <div
                            ...
                            <div className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
                                ...
                                <button
                                    className="inline-flex w-full items-center justify-center bg-black px-6 py-4 text-lg text-white transition-all duration-200 ease-in-out focus:shadow font-medium uppercase tracking-wide">Login
                                </button>
