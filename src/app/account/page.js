...
export default function Account() {
    ...
    async function handleAddOrUpdateAddress() {
        const res = currentEditAddressID !== null ? await updateAddress({...addressFormData, _id: currentEditAddressID})
    ...
    function handleUpdateAddress(currentAddress) {
        setAddressFormData({
            ...
            star: currentAddress.star,
        });
        setCurrentEditAddressID(currentAddress.id);
