                    ...
                    <div className="bg-white shadow">
                        <div className="px-4 py-6 sm:px-8 sm:py-10">
                            ...
                            <div className="mt-5 text-center">
                                <button disabled={cartItems && cartItems.length === 0} className="group inline-flex w-full items-center justify-center bg-black px-6 py-4 text-lg text-white font-medium uppercase disabled:opacity-50">Checkout</button>
                            </div>
                        </div>
                    </div>
                </div>
